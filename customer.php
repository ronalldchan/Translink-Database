<html>
    ...
    <body>
        ...
        <h2>Customer Page</h2>
        <p>This is the customer page of the project with actions relating to bus.</p>
        ...
        <form method="POST" action="customer.php"> <!--refresh page when submitted-->
            ...
            *Customer ID: <input type="text" name="insID"> <br /><br />
            *Customer Name: <input type="text" name="insName"> <br /><br />
            +Stop ID: <input type="text" name="insStop"> <br /><br />
            <input type="submit" value="Insert" name="insertSubmit"></p>
        </form>

        <hr />

        <h2>Update Attribute of a Customer</h2>
        ...
        <h2>Project and Display all Customers</h2>
        <form method="GET" action="customer.php"> <!--refresh page when submitted-->
            <input type="hidden" id="displayTupleRequest" name="displayTupleRequest">
            <input type="checkbox" name="cID" value='customerID' checked></input>Customer ID<br>
            <input type="checkbox" name="cName" value='customerName' checked></input>Customer Name<br>
            <input type="checkbox" name="cStop" value='stopID' checked></input>Stop ID<br>
            <input type="submit" name="displayTuples"></p>
        </form>

        <hr />

        <h2>Project and Select Customers</h2>
        <form method="GET" action="customer.php"> <!--refresh page when submitted-->
        ...
        function handleInsertRequest() {
            ...
            $allCustomerTuples = array (
                $customerTuple
            );

            executeBoundSQL("insert into customer values (:bind1, :bind2, :bind3)", $allCustomerTuples);
            OCICommit($db_conn);
        }
        ...
        function handleUpdateRequest() {
            ...
            $command = "UPDATE customer SET " . $newAttribute . " = '" . $newValue . "' WHERE " . $oldAttribute . " = '" . $oldValue . "'";
        ...
        function handleSelectRequest() {
            ...
            $command = substr($command, 0, strlen($command) - 2) . " ";
            $command .= "FROM customer WHERE " . $_GET['attribute'] ;
