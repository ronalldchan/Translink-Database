<!--Test Oracle file for UBC CPSC304 2018 Winter Term 1
  ...
  <html>
    <head>
        <title>CPSC 304 Project: TransLink Transit System</title>
    </head>

    <body>
        <h1>CPSC 304 Project: TransLink Transit System</h1>
        <h2>Reset</h2>
        <p>Reset table values to default.</p>
        ...
        <form method="POST" action="webpage.php"> <!--refresh page when submitted-->
        ...
        <form method="GET" action="webpage.php"> <!--refresh page when submitted-->
